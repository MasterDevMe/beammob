...
<div class="entityInfo">
	...
	<div class="rightSection">
		...
		<p><h4><?php echo $album->getAlbumPrice(); ?> usd</h4></p>

		<p role="link" tabindex="0" onclick="openPage('artist.php?id=<?php echo $artistId; ?>')">Download (recommended),  Streaming available</p>
